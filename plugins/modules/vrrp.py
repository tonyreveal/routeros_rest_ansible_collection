...
---
module: vrrp
short_description: Manage RouterOS VRRP interfaces through the REST API
description:
  - Creates, updates, or removes a VRRP interface.
  - The settings dictionary contains RouterOS VRRP properties.
version_added: '1.0.0'
author:
...
options:
  ...
  name:
    ...
    required: true
  settings:
    description: RouterOS VRRP properties.
    type: dict
    required: true
    suboptions:
      interface:
      ...
      vrid:
        ...
        type: int
      priority:
        description: VRRP election priority.
        type: int
      version:
...
def main() -> None:
    ...
    p = module.params
    run_config(module, "interface/vrrp", {"name": p["name"]}, {"name": p["name"], **p["settings"]})
