...
short_description: Gather RouterOS certificate information
description:
  - Reads RouterOS certificate records through the REST API.
...
options:
  ...
  password:
    ...
    no_log: true
  name:
    description: Optional certificate name filter.
    type: str
  object_id:
...
- name: Read certificates
  mikrotik.routeros_rest.certificate_info:
...
def main() -> None:
    ...
    run_info(module, "certificate", "certificates", "name")
