...
DOCUMENTATION = r"""
---
module: ipv6_firewall_info
short_description: Manage or gather RouterOS ipv6 firewall info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads IPv6 firewall records from RouterOS.
...
EXAMPLES = r"""
---
- name: Gather IPv6 firewall
  hosts: localhost
  gather_facts: false
  tasks:
    - name: Read IPv6 firewall
      mikrotik.routeros_rest.ipv6_firewall_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_ipv6_firewall_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_ipv6_firewall_info.rules
...
"""
...
def main() -> None:
    ...
    run_info(module, "ipv6/firewall/filter", "rules", "comment")
