...
DOCUMENTATION = r"""
---
module: ipsec_policy_info
short_description: Gather RouterOS IPsec policy information through the REST API
description:
  - Reads IPsec policy records.
...
options:
  ...
  password:
    ...
    no_log: true
  name:
    description: Optional policy comment selector.
    type: str
  object_id:
...
def main() -> None:
    ...
    run_info(module, "ip/ipsec/policy", "policies", "comment")
