...
---
module: dns_info
short_description: Manage or gather RouterOS dns info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads DNS records from RouterOS.
...
def main() -> None:
    ...
    run_info(module, "ip/dns", "dns", None)
