...
---
module: user_info
short_description: Manage or gather RouterOS user info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads user records from RouterOS.
...
def main() -> None:
    ...
    run_info(module, "user", "users", "name")
