...
DOCUMENTATION = r"""
---
module: ipsec_profile_info
short_description: Gather RouterOS IPsec profile information through the REST API
description:
  - Reads IPsec profile records.
...
def main() -> None:
    ...
    run_info(module, "ip/ipsec/profile", "profiles", "name")
