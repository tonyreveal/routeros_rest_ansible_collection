...
DOCUMENTATION = r'''
---
module: interface_counter_info
short_description: Gather interface traffic counters
description:
  - Reads interface traffic counters from RouterOS through the REST API.
...
EXAMPLES = r'''
---
- name: Read interface counter
  mikrotik.routeros_rest.interface_counter_info:
...
def main() -> None:
    ...
    run_info(module, "interface", "counters", "name")
