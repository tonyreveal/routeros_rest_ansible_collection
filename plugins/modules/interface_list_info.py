...
DOCUMENTATION = r"""
---
module: interface_list_info
short_description: Manage or gather RouterOS interface list info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads interface list records from RouterOS.
...
EXAMPLES = r"""
---
- name: Gather interface list
  hosts: localhost
  gather_facts: false
  tasks:
    - name: Read interface list
      mikrotik.routeros_rest.interface_list_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_interface_list_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_interface_list_info.lists
...
"""
...
def main() -> None:
    ...
    run_info(module, "interface/list", "lists", "name")
