...
DOCUMENTATION = r"""
---
module: ipv6_route_info
short_description: Manage or gather RouterOS ipv6 route info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads IPv6 route records from RouterOS.
...
EXAMPLES = r"""
---
- name: Gather IPv6 route
  hosts: localhost
  gather_facts: false
  tasks:
    - name: Read IPv6 route
      mikrotik.routeros_rest.ipv6_route_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_ipv6_route_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_ipv6_route_info.routes
...
"""
...
def main() -> None:
    ...
    run_info(module, "ipv6/route", "routes", "dst-address")
