...
DOCUMENTATION = r"""
---
module: routerboard_info
short_description: Manage or gather RouterOS routerboard info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads RouterBOARD records from RouterOS.
...
EXAMPLES = r"""
---
- name: Gather RouterBOARD
  hosts: localhost
  gather_facts: false
  tasks:
    - name: Read RouterBOARD
      mikrotik.routeros_rest.routerboard_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_routerboard_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_routerboard_info.routerboard
...
"""
...
def main() -> None:
    ...
    run_info(module, "system/routerboard", "routerboard", None)
