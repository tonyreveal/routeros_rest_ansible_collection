...
DOCUMENTATION = r"""
---
module: ipv6_address_info
short_description: Manage or gather RouterOS ipv6 address info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads IPv6 address records from RouterOS.
...
- name: Gather IPv6 address
  ...
  gather_facts: false
  tasks:
    - name: Read IPv6 address
      mikrotik.routeros_rest.ipv6_address_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_ipv6_address_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_ipv6_address_info.addresses
...
"""
...
def main() -> None:
    ...
    run_info(module, "ipv6/address", "addresses", "address")
