...
DOCUMENTATION = r"""---
module: ipv6_route
short_description: Manage or gather RouterOS ipv6 route information
description:
...
def main():
    m = AnsibleModule(
        argument_spec={
            ...
            "routing_table": {"type": "str", "default": "main"},
            "distance": {"type": "int"},
    ...
    p = m.params
    d = {
        "dst-address": p["dst_address"],
        "gateway": p["gateway"],
        "routing-table": p["routing_table"],
        "disabled": p["disabled"],
    }
    ...
    try:
        reconcile(
            ...
            "ipv6/route",
            {"dst-address": p["dst_address"], "gateway": p["gateway"]},
            d,
            p["state"],
            "route",
        )
