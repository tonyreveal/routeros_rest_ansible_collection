...
---
module: snmp_info
short_description: Gather RouterOS SNMP community information through the REST API
description:
  - Reads RouterOS SNMP community records.
...
def main() -> None:
    ...
    run_info(module, "snmp/community", "communities", "name")
