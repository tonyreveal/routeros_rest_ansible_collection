...
---
module: gre_info
short_description: Gather RouterOS GRE tunnel information through the REST API
description:
  - Reads GRE tunnel interface records.
...
options:
  ...
  password:
    ...
    no_log: true
  name:
    description: Optional GRE tunnel name.
    type: str
  object_id:
...
def main() -> None:
    ...
    run_info(module, "interface/gre", "interfaces", "name")
