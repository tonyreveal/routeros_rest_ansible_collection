...
DOCUMENTATION = r"""
---
module: wireguard_info
short_description: Gather RouterOS WireGuard interface information through the REST API
description:
  - Reads WireGuard interface records.
...
options:
  ...
  password:
    ...
    no_log: true
  name:
    description: Optional WireGuard interface name.
    type: str
  object_id:
...
RETURN = r"""
interfaces:
  description: WireGuard interface records returned by RouterOS.
  returned: always
  type: list
  elements: dict
"""
...
def main() -> None:
    ...
    run_info(module, "interface/wireguard", "interfaces", "name")
