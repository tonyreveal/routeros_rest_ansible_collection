...
DOCUMENTATION = r'''
---
module: certificate_sign
short_description: Manage RouterOS certificate signing settings
description:
  - Reconciles signing properties for a RouterOS certificate through the REST API.
version_added: '1.0.0'
author:
...
options:
  ...
  name:
    ...
    required: true
  settings:
    description: Certificate signing properties.
    type: dict
    required: true
    suboptions:
      ca:
        description: Whether the certificate acts as a CA.
        type: bool
      ca_crl_host:
        description: CRL distribution host.
        type: str
      days_valid:
...
EXAMPLES = r'''
---
- name: Configure certificate signing properties
  mikrotik.routeros_rest.certificate_sign:
