...
DOCUMENTATION = r"""
---
module: connection_tracking_info
short_description: Gather RouterOS connection-tracking settings through the REST API
description:
  - Reads the RouterOS connection-tracking singleton.
