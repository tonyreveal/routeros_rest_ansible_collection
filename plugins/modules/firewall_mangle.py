...
DOCUMENTATION = r"""
---
module: firewall_mangle
short_description: Manage RouterOS IPv4 firewall mangle rules through REST
description:
  - Creates, updates, and removes IPv4 firewall mangle rules.
version_added: '1.0.0'
author:
