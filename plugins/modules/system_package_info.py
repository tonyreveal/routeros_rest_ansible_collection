...
DOCUMENTATION = r"""
---
module: system_package_info
short_description: Manage or gather RouterOS system package info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads system package records from RouterOS.
...
EXAMPLES = r"""
---
- name: Gather system package
  hosts: localhost
  gather_facts: false
  tasks:
    - name: Read system package
      mikrotik.routeros_rest.system_package_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_system_package_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_system_package_info.packages
...
"""
...
def main() -> None:
    ...
    run_info(module, "system/package", "packages", "name")
