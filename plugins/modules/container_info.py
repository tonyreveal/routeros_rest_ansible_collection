...
short_description: Gather RouterOS container information
description:
  - Reads RouterOS container records through the REST API.
...
EXAMPLES = r'''
---
- name: Read RouterOS containers
  mikrotik.routeros_rest.container_info:
...
RETURN = r'''
containers:
  description: RouterOS container records.
  returned: always
  type: list
  elements: dict
'''
...
def main() -> None:
    ...
    run_info(module, "container", "containers", "name")
