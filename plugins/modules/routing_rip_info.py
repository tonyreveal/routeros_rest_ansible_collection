...
DOCUMENTATION = r"""
---
module: routing_rip_info
short_description: Gather RouterOS RIP instance information through the REST API
description:
  - Reads RouterOS RIP instance records.
...
options:
  ...
  password:
    ...
    no_log: true
  name:
    description: Optional RIP instance name.
    type: str
  object_id:
...
def main() -> None:
    ...
    run_info(module, "routing/rip/instance", "instances", "name")
