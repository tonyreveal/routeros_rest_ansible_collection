...
DOCUMENTATION = r'''
---
module: dhcpv6_lease_info
short_description: Gather RouterOS DHCPv6 leases
description:
  - Reads RouterOS DHCPv6 leases through the REST API.
...
EXAMPLES = r'''
---
- name: Read RouterOS DHCPv6 leases
  mikrotik.routeros_rest.dhcpv6_lease_info:
...
RETURN = r'''
leases:
  description: RouterOS DHCPv6 leases.
  returned: always
  type: list
  elements: dict
'''
...
def main() -> None:
    ...
    run_info(module, "ipv6/dhcp-server/lease", "leases", "name")
