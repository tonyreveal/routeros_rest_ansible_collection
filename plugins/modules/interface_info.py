...
short_description: Manage or gather RouterOS interface info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads Interface records from RouterOS.
...
- name: Gather Interface
  ...
  tasks:
    - name: Read Interface
      mikrotik.routeros_rest.interface_info:
        host: https://192.0.2.1
        username: "{{ vault_routeros_username }}"
        password: "{{ vault_routeros_password }}"
      register: routeros_interface_info

    - name: Show returned data
      ansible.builtin.debug:
        var: routeros_interface_info.interfaces
...
"""
...
def main() -> None:
    ...
    run_info(module, "interface", "interfaces", "name")
