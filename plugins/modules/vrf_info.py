...
---
module: vrf_info
short_description: Manage or gather RouterOS vrf info information
seealso:
...
attributes:
  check_mode:
    ...
    support: full
description:
  - Reads VRF records from RouterOS.
...
def main() -> None:
    ...
    run_info(module, "ip/vrf", "vrfs", "name")
